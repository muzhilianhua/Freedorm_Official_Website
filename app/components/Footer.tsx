    ...
    <footer className="w-full bg-primary text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#comparison" className="hover:text-gray-300 transition-colors">
                  安装说明
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-white border-opacity-20 text-center">
          ...
          <p>备案号：<a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener noreferrer">豫ICP备2024105509号-2</a></p>
        </div>
      </div>
    </footer>
  );
